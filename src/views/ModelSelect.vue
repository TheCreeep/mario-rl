<template>
  <div class="content">
    <div class="content__select">
      <img class="content__select__hand" @click="scrollLeft()" src="../assets/lefthand.png" />
      <div class="content__select__models">
        <div class="content__select__models__modelpage" v-for="page in pages">

          <div class="content__select__models__modelpage__model" v-for="model in page" :key="model.id">
            <div class="top">
              {{ model.name }}
            </div>
            <div class="bottom">
      ...
      <img class="content__select__hand" @click="scrollRight()" src="../assets/righthand.png" />
...
export default {
  ...
  computed: {
    numberOfPages() {
      return Math.ceil(this.models.length / 10)
    },
    /* Pages that splits models in groups of 10 model */
    pages() {
      let pages = []
      for (let i = 0; i < this.numberOfPages; i++) {
        pages.push(this.models.slice(i * 10, (i + 1) * 10))
      }
      return pages
    }
  },
  ...
  &__select {
    ...
    &__models {
      ...
      &__modelpage {
        ...
        justify-content: flex-start;
        gap: 3em;
        min-width: calc(230px * 5 + (3em * 4) + (3px * 2 * 5));
